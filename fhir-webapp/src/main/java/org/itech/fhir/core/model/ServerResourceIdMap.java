...
import org.itech.fhir.core.validation.annotation.ValidIdMap;
import org.itech.fhir.core.validation.constraint.IdMapValidator.IdType;
...
@Setter
@Entity
@Table(uniqueConstraints = { @UniqueConstraint(columnNames = { "source_server_id", "resource_type" }) })
public class ServerResourceIdMap extends PersistenceEntity<Long> {
	...
	private Map<String, String> sourceIdToLocalIdMap;

	ServerResourceIdMap() {

	}

	public ServerResourceIdMap(FhirServer server, ResourceType resourceType) {
		sourceIdToLocalIdMap = new HashMap<>();
		sourceServer = server;
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(serverResourceIdMap.resourceType, this.resourceType)
				&& Objects.equals(serverResourceIdMap.sourceServer, this.sourceServer);
	}

	@Override
	public int hashCode() {
		return Objects.hash(resourceType, sourceServer);
	}
